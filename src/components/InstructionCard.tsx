  ...
  return (
    <div className="card border-0">
      ...
      <div className="card-body">
        <p className="card-text">1. You can no longer change once you've selected an answer.</p>
        <p className="card-text">2. You can't exit the Quiz once while playing.</p>
        <p className="card-text">3. You'll earn points based on your correct answers.</p>
      </div>
